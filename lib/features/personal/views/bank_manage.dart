...
class BankManageView extends StatelessWidget {
      ...
      body: BlocConsumer<BankManageBloc, BankManageState>(
        listener: ((context, state) {
          ...
          if (state is BankManageAddSuccessState) {
            //pop loading and pop bank sheet is outside sms_list screen
            //DO NOT NEED TO POP HERE
            getListBank(context);
          }
        }),
              ...
              children: [
                ...
                ButtonWidget(
                  ...
                  function: () async {
                    ...
                    await SettingBankSheet.instance.openAddingFormCard(banks,
                        _bankAccountController, _bankAccountNameController);
                  },
                ),
  ...
  Widget _buildTabButton({
    ...
    return ButtonWidget(
      ...
      bgColor: (isSelected)
          ? Theme.of(NavigationService.navigatorKey.currentContext!).canvasColor
