...
class UserEditView extends StatelessWidget {
  ...
  void initialServices(BuildContext context) {
    ...
    if (userInformationDTO.lastName.isNotEmpty &&
        _lastNameController.text.isEmpty) {
      _lastNameController.value =
          _lastNameController.value.copyWith(text: userInformationDTO.lastName);
    }
    if (userInformationDTO.middleName.isNotEmpty &&
    ...
    if (userInformationDTO.firstName.isNotEmpty &&
    ...
    if (userInformationDTO.address.isNotEmpty &&
