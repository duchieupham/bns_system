...
class SettingBankSheet {
  ...
  Future openAddingFormCard(
    ...
    final BankManageBloc _bankManageBloc = BlocProvider.of(context);
                      ...
                      ButtonWidget(
                        ...
                        function: () {
                          if (bankSelected != 'Chọn ngân hàng') {
                            ...
                            _bankManageBloc.add(BankManageEventAddDTO(
                                userId:
                    ...
                    child: Column(
                      children: [
                        ...
                        ButtonWidget(
                          ...
                          function: () {
                            final BankManageBloc _bankManageBloc =
                                BlocProvider.of(context);
                            _bankManageBloc.add(BankManageEventRemoveDTO(
